<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h2>Python Scraping - CoolWorks</h2>
        </div>
    </div>
</div>
...
<select class="form-control" id="sel">
	...
	<option value="coolworks" selected>CoolWorks</option>
...
<table class="table table-bordered">
    ...
    <?php
        ...
        <tr>
            ...
            <td><?php echo $item->jobPay?></td>
            <td><?php echo $item->jobAgo ?></td>
            <td><?php echo $item->jobStartDate ?></td>  
            <td><?php echo $item->jobExperience ?></td>  
