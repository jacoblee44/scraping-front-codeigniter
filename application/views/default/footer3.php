...
<script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDs-0kCpaWs6MLA3beRKO690-NdIL_ubn0&callback=initAutocomplete&libraries=places&v=weekly"
      defer
    ></script>
...
<script>
    $(document).ready( function () {
	   	dataTable = $('#google-search').DataTable({
			'processing': true,
			'serverSide': true,
			'serverMethod': 'post',
			'ajax': {
				'url':'<?=site_url()?>/ItemCRUD/westin_search'
